"""HTTP and CLI entry point for the APM Validation agent.

Running python -m agent_apm_validation.server performs one job invocation
and exits with a JSON result. Serving agent_apm_validation.server:app
